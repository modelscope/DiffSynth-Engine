...
if __name__ == "__main__":
    ...
    pipe.load_loras([("wan22-style1-violetevergarden-16-sel-2-high-000100.safetensors", 1.0)], fused=False, save_original_weight=False)
    pipe.load_loras_low_noise([("wan22-style1-violetevergarden-16-sel-2-low-000100.safetensors", 1.0)], fused=False, save_original_weight=False)
