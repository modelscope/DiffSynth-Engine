...
class TestFLUXBFLImage(ImageTestCase):
    ...
    def _test_canny_txt2img(self) -> None:
        ...
        # )
        self.canny_model_path = "/mnt/muse-amd-nas/flux1-canny-dev.safetensors"

        self.pipe = FluxImagePipeline.from_pretrained(
            self.canny_model_path, control_type=ControlType.bfl_control
        ).eval()
    ...
    def _test_depth_txt2img(self):
        ...
        self.depth_model_path = "/mnt/muse-amd-nas/flux1-depth-dev.safetensors"

        self.pipe = FluxImagePipeline.from_pretrained(
            self.depth_model_path, control_type=ControlType.bfl_control
        ).eval()
        width, height = 1024, 1024
    ...
    def test_fill_txt2img(self):
        ...
        self.fill_model_path = "/mnt/muse-amd-nas/flux1-fill-dev.safetensors"
