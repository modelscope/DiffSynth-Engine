...
class TestFLUXBFLCannyImage(ImageTestCase):
    ...
    def setUpClass(cls):
        ...
        config = DiffsynthConfig(model_path=cls.canny_model_path, control_type=ControlType.bfl_control)
...
class TestFLUXBFLDepthImage(ImageTestCase):
    ...
    def setUpClass(cls):
        ...
        config = DiffsynthConfig(model_path=cls.depth_model_path, control_type=ControlType.bfl_control)
        cls.pipe = FluxImagePipeline.from_pretrained(config)
...
class TestFLUXBFLFillImage(ImageTestCase):
    ...
    def setUpClass(cls):
        ...
        config = DiffsynthConfig(model_path=cls.fill_model_path, control_type=ControlType.bfl_fill)
        cls.pipe = FluxImagePipeline.from_pretrained(config)
...
class TestFLUXBFLKontextImage(ImageTestCase):
    ...
    def setUpClass(cls):
        ...
        config = DiffsynthConfig(model_path=kontext_model_path, control_type=ControlType.bfl_kontext)
        cls.pipe = FluxImagePipeline.from_pretrained(config)
