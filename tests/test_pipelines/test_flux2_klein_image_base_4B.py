...
class TestFlux2KleinPipeline(ImageTestCase):
    ...
    def setUpClass(cls):
        config = Flux2KleinPipelineConfig(
            model_path=fetch_model("black-forest-labs/FLUX.2-klein-base-4B", path="transformer/*.safetensors"),
    ...
    def test_txt2img(self):
        ...
        self.assertImageEqualAndSaveFailed(image, "flux2/image_base_4B.jpg", threshold=0.95)
        ...
        self.assertImageEqualAndSaveFailed(image, "flux2/image_edit_base_4B.jpg", threshold=0.95)
