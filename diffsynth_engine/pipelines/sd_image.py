...
class SDImagePipeline(BasePipeline):
    ...
    @classmethod
    def from_pretrained(cls, config: DiffsynthConfig) -> "SDImagePipeline":
        ...
        with LoRAContext():
            text_encoder = SDTextEncoder.from_state_dict(clip_state_dict, device=init_device, dtype=config.clip_l_dtype)
