...
class WanVideoPipeline(BasePipeline):
    ...
    def __init__(
        ...
        super().__init__(
            vae_tiled=config.vae_tiled if config.vae_tiled is not None else True,
            vae_tile_size=config.vae_tile_size if config.vae_tile_size is not None else (34, 34),
            vae_tile_stride=config.vae_tile_stride if config.vae_tile_stride is not None else (18, 16),
    ...
    @classmethod
    def from_pretrained(cls, config: DiffsynthConfig) -> "WanVideoPipeline":
