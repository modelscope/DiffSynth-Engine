# Adapted from https://github.com/huggingface/diffusers/blob/main/src/diffusers/models/transformers/transformer_wan_vace.py
...
class WanVACETransformer3DModel(DiffusionModel):
    ...
    Args:
        ...
        image_dim (`int`, *optional*, defaults to `None`):
            Dimension for image embeddings (used in I2V models).
        added_kv_proj_dim (`int`, *optional*, defaults to `None`):
            The number of channels for added key and value projections.
