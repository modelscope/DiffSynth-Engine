...
def extract_audio_feat(audio_path: str, model: Wav2Vec2Model, dtype=torch.float32, device="cuda:0") -> torch.Tensor:
    video_rate = 30  # TODO: maybe later we can have a node to load audio, and move this outside
