...
from .zh_num2words import TextNorm
...
def expand_numbers_multilingual(text, lang="en"):
    if lang == "zh":
        ...
        try:
            ...
            logger.warning(f"Failed to expand currency: {e}")
        if lang != "tr":
            text = re.sub(
...
def multilingual_cleaners(text, lang):
    ...
    try:
        ...
        logger.warning(f"Failed to expand numbers: {e}")
    try:
    ...
    try:
        ...
        logger.warning(f"Failed to expand symbols: {e}")
